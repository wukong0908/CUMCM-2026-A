...
表9.1  问题一:关键参数 ±10%,t=1800 s 温度/水分最大变化
表6.6  问题二:关键参数 ±10%,3 h 输出的影响
表6.3.4 问题三:关键参数 ±10%,烘干终点
表6.4.2 问题四:关键参数 ±10%,烘干终点

运行:python 灵敏度.py(问题三/四部分需全程求解,约数小时;问题一/二为秒级)
BC 口径:附件 1 取 PCHIP 插值,4 h 后取末端值恒定(与论文一致)。
"""
import os
import sys
import time
